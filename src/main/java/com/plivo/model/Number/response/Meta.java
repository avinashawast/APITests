...
public class Meta {
    ...
    public String toString() {
        return new ToStringBuilder(this).append("limit", limit).append("next", next).append("offset", offset).append("previous", previous).append("totalCount", totalCount).append("additionalProperties", additionalProperties).toString();
    }
}
